...
const api = {
  list: async (): Promise<Restaurant[]> => {
    ...
    const [, ...data] = await fetch("https://docs.google.com/spreadsheets/d/e/2PACX-1vR_4pGF-dyskUp_X09es4NepFYII7CzWG-TDGQT9PVqVwVlyOxxvpjiKvxBrauPZtSdVKod2-5M6l4H/pub?output=csv")
    .then(res => res.text())
